/**
 * Use for JavaScript compatibility by using anonymous functions.
 *
 * @summary   Gofer SEO Tooltips JS
 *
 * @since     1.0.0
 */
...
(function($) {
	 ...
	 */
	function goferSEOTooltips() {
		$( '.gofer-seo-tooltip' ).tooltip({
			...
			classes: {
				'ui-tooltip': 'ui-corner-all ui-widget-content gofer-seo-ui-tooltip'
			},
			tooltipClass: 'gofer-seo-ui-tooltip',
