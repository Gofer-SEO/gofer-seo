...
class WP_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by WordPress to make your content more visible for search engines.', 'gofer-seo' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
			esc_url( __( 'https://www.sitemaps.org/', 'gofer-seo' ) ),
			esc_xml( __( 'Learn more about XML sitemaps.', 'gofer-seo' ) )
		);
		...
		$url        = esc_xml( __( 'URL', 'gofer-seo' ) );
		$lastmod    = esc_xml( __( 'Last Modified', 'gofer-seo' ) );
		$changefreq = esc_xml( __( 'Change Frequency', 'gofer-seo' ) );
		$priority   = esc_xml( __( 'Priority', 'gofer-seo' ) );
