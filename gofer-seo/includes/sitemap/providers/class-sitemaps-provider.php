...
/**
 * Class Gofer_SEO_Sitemaps_Provider.
 *
 * @since 1.0.0
 */
class Gofer_SEO_Sitemaps_Provider extends WP_Sitemaps_Provider {
	...
	/**
	 * Gofer_SEO_Sitemap_Data constructor.
	 *
	 * @since 1.0.0
	 */
	public function __construct() {
		add_filter( 'wp_sitemaps_index_entry', array( $this, 'sitemaps_index_entry' ), 10, 4 );
		add_filter( 'gofer_seo_sitemaps_index_entry', array( $this, 'sitemaps_index_entry' ), 10, 4 );
	}
	...
	public function get_sitemap_list() {
		...
		foreach ( $sitemap_types as $type ) {
			for ( $page = 1; $page <= $type['pages']; $page++ ) {
				 ...
				 */
				$sitemap_entry = apply_filters( 'gofer_seo_sitemaps_index_entry', $sitemap_entry, $this->object_type, $type['name'], $page );
