...
/**
 * Class Gofer_SEO_Graph_BreadcrumbList.
 *
 * @since 1.0.0
 *
 ...
 */
class Gofer_SEO_Graph_BreadcrumbList extends Gofer_SEO_Graph_ItemList {
	...
	protected function prepare( $data = array() ) {
		...
		$rtn_data = array(
			'@type'           => $this->slug,
			'@id'             => $context->get_canonical_url() . '#' . strtolower( $this->slug ),
