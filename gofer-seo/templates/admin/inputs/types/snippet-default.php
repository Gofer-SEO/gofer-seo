<?php
/**
 * Input - Snippet Default.
 *
 * Displays a preview example of the search results that would be displayed to others.
 *
 * @see goferSeoInputSnippetPreview() in `admin/js/inputs/types/snippet-default.js` Used to construct the snippet.
 *
 * @package Gofer SEO
 * @since 1.0.0
 *
...
wp_enqueue_script( 'gofer-seo-input-type-snippet-default-js' );
wp_enqueue_style( 'gofer-seo-input-type-snippet-default-css' );
?>
<div class="gofer-seo-snippet-g">
	<div class="gofer-seo-snippet-rc">
		<div class="gofer-seo-snippet-header">
			<a>
				<div class="gofer-seo-snippet-site-sources">
					<div>
						<cite class="gofer-seo-snippet-site-url">example.test<span class="gofer-seo-snippet-breadcrumb-url"></span></cite>
					</div>
					<div>
						<span class="dashicons dashicons-arrow-down"></span>
					</div>
				</div>
				<h3 class="gofer-seo-snippet-title">Page Title | Site Header</h3>
			</a>
		</div>
		<div class="gofer-seo-snippet-content">
			<div>
				<div>
					<span class="gofer-seo-snippet-description">
						Contains the description.
					</span>
					<span class="gofer-seo-snippet-description-long">
						Too Long.
					</span>
				</div>
			</div>
